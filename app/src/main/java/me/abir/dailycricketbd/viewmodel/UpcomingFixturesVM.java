 ...
 */
public class UpcomingFixturesVM extends ViewModel {

    private static final String TAG = "UpcomingFixturesVM";
    ...
    private void loadResults(String token) {
        ...
        apiInterface.getFixtureInfo(token, 1).enqueue(new Callback<ResultsModel>() {
            @Override
